...
- [Computer Science](compsci/README.md)
  - [Databases](databases/README.md)
    - [Database Normalization](databases/normalization.md)
  - [Networking](compsci/networking/README.md)
    - [HTTP Protocol](compsci/networking/http.md)
    - [TCP Protocol](compsci/networking/tcp.md)
